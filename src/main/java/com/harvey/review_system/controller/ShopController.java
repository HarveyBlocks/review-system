...
import com.harvey.review_system.utils.SystemConstants;
...
public class ShopController {
    ...
    public Result queryShopById(@PathVariable("id") Long id, HttpServletResponse response) {
        Shop shop = shopService.queryMutexFixByLogicalTtl(id);
        if (shop == null) {
    ...
    public Result updateShop(@RequestBody Shop shop) {
        ...
        // 写入数据库
        return shopService.updateCache(shop) ? Result.ok() : Result.fail("找不到对象");
    }
